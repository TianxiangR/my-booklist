...
## Key Features
- **Book List Display**: Each book's entry shows its name, author, price, category, and options to edit or delete.
...
- **Responsive UI**: Toast notifications for actions, ellipses with popover tips for long titles, and a clean, user-friendly interface.
